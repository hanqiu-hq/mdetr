...
def main(args):
    ...
    dset = build_dataset("coco", image_set="val", args=args)
    ...
    evaluator = CocoEvaluator(dset.coco, ("bbox",))

    postprocessor = build_postprocessors(args)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("COCO evaluation script", parents=[get_args_parser()])
